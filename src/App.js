    ...
    return (
        <>
            <div className="container">
                ...
                {isSuccessVisible && <SuccessAnimation status={successStatus} />}
                ...
                <div className="btn-style">
                    ...
                    <button onClick={SpeechRecognition.stopListening}> <BiPauseCircle /></button>
                    <button onClick={() => handleMatch(transcript)}> check </button>
                    <button onClick={() => setSelectedMantra('Om Krishnaya Namaha')}>Om Krishnaya Namaha</button>
                    <button onClick={() => setSelectedMantra('Aum Devkinandanaye Vidmahe Vasudevaye Dhi-Mahi Tanno Krishna Prachodayat')}>Aum Devkinandanaye Vidmahe Vasudevaye Dhi-Mahi Tanno Krishna Prachodayat</button>
                    <button onClick={() => setSelectedMantra('Om Sri Krishnah sharanam mamah')}>Om Sri Krishnah sharanam mamah</button>
                </div>
            </div>
        </>
    );
